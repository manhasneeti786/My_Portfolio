  ...
  return (
    ...
    <hr/>
     ...
     <footer className='py-12  bg-blue-950  text-white'>
        <div className='w-full max-w-screen-2xl container md:ml-0 mx-auto px-4 md:px-20 my-20'>
       ...
       <div className='flex  space-x-1'> <MdEmail className='mt-1' /> <span className='text-sm md:text-xl'>neetimanhas661@gmail.com</span></div>
