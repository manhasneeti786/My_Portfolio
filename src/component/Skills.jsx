...
},
{
  ...
  return (
    ...
    className=' bg-blue-950  text-white max-w-screen-2xl container mx-auto px-4 my-20 md:px-20'>
      ...
      <motion.p 
         ...
         transition={{delay: 0.1, duration: 0.5 }}
      className='md:text-xl'>I've experience in below technologies: </motion.p>
      <br/> <br/>
      <div className='space-y-4 mr-12 md:mr-0'>
               <div className='flex items-center'>
                    <label htmlFor="Htmlandcss" className='w-2/12 md:text-xl text-sm'>HTML & CSS</label>
                    <div className='grow bg-gray-800 ml-12  md:ml-0  rounded-full h-2.5'>
               ...
               <div className='flex items-center'>
                    ...
                    <div className='grow bg-gray-800 rounded-full ml-12  md:ml-0  h-2.5'>
                         <div className='bg-gradient-to-r from-sky-400 to-cyan-300 h-2.5 rounded-full transform 
      ...
      <div className='grid grid-cols-2 md:grid-cols-5 gap-12 my-3'>
    {
        Carditems.map(({id, logo})=> (
            <div className=' flex flex-col items-center justify-center mr-12 md:mr-0
             bg-white border-[2px]  rounded-full md:w-[150px] md:h-[150px] shadow-lg p-1 cursor-pointer hover:scale-110 duration-300'
             key={id}>
                <motion.img 
                     ...
                     transition={{ delay:0.1, duration: 0.5}}
                src={logo} className='w-[150px] rounded-full' alt='logo' />
            </div>
